...
if(isset($_SESSION["erreur"])&& $_SESSION["erreur"]==true && isset($_SESSION["mdpcorrecte"]) && $_SESSION["mdpcorrecte"]==true){

    echo'<script> alert("Faux parametre")</script>';
...
if(isset($_SESSION["mdpcorrecte"])&&$_SESSION["mdpcorrecte"]==false)
{
    echo'<p style="color:red;"> mot de passe incorrecte</p>';
    $_SESSION["mdpcorrecte"]==true;
}
?>
            ...
            <p text-center>Vous n'avez pas encore un compte? <a href="inscrip.php">Inscrivez vous</a></p>
        </div>
    </body>
</html>